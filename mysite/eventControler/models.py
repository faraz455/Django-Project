...
from user.models import CustomUser, Address_Global

# code used from https://github.com/adefemi/django_tut/tree/complex-queries/event_controller
...
class EventMain(models.Model):
    ...
    address_info = models.ForeignKey(
        Address_Global, related_name="event_address", on_delete=models.CASCADE)
